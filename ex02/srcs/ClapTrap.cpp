...
/*   Updated: 2024/08/12 09:43:54 by nsouchal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name, int _attack_damage, int _energy_points, int _hit_points): _name(name), _hit_points(_hit_points), _energy_points(_energy_points), _attack_damage(_attack_damage)
{
	std::cout << "Specified attributs ClapTrap constructor called" << std::endl;
	return ;
}
